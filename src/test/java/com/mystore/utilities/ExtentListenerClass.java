...
public class ExtentListenerClass implements ITestListener {
	...
	public void configureReport()
	{
		...
		String reportName = "ECommerceTestReport-" + timestamp + ".html";
		...
		reports.setSystemInfo("user name:", "Yogesh");
		
		//configuration to change look and feel of report
		htmlReporter.config().setDocumentTitle("Extent Ecommerce Report Demo");
		htmlReporter.config().setReportName("This is my First Ecommerce Report");
